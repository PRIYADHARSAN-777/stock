...
import { CheckCircle2, TrendingUp, Zap, ChevronsRight, Target, Shield, DollarSign, List, BarChart2, Briefcase, Award, Gem, TrendingDown, ArrowRight } from 'lucide-react';
  ...
  const allPages = [
            ...
            <div className="flex gap-4">
                <div className="w-1/3 border-2 border-brand-black rounded-lg p-3 bg-white/30 flex flex-col justify-center">
                     ...
                     <ul className="space-y-2 text-sm font-semibold">
                         ...
                         <li className="flex items-center gap-2"><div className="w-5 h-5 rounded-full bg-lime-400 border-2 border-brand-black shrink-0"></div>Greed (50 - 70)</li>
    ...
    <Page key="page-3" title="Stonkzz" pageNumber={3} date={data.date}>
       <Section title="Nifty Open Interest Analysis" icon={<Target className="text-brand-black"/>}>
            ...
            />
            <div className="mt-4 space-y-4 text-base text-brand-black">
    ...
    <Page key="page-6" title="Stonkzz" pageNumber={6} date={data.date}>
      ...
      <Section title="FII DII Data" icon={<BarChart2 className="text-brand-black"/>}>
        <img src="https://raw.githubusercontent.com/Prasannapriyan/Generator/refs/heads/main/Data/fii.png" alt="FII DII Data Chart" className="w-full rounded-lg border-2 border-brand-black" />
      </Section>        
    </Page>,
        ...
        {data.highLowData && (
          <div className="grid grid-cols-2 gap-6 mt-6">
              <Section title="52W High" icon={<TrendingUp className="text-brand-green"/>}>
                  <InfoTable
                      headers={['Stock', 'Price', 'Change %']}
                      rows={data.highLowData.highs.map(stock => [stock.name, `₹${stock.price}`, `+${stock.change}%`])}
    ...
    <Page key="page-8" title="Stonkzz" pageNumber={8} date={data.date}>
      ...
      <Section title="SGX NIFTY Data" icon={<BarChart2 className="text-brand-black"/>}>
       <img src="https://raw.githubusercontent.com/Prasannapriyan/Generator/refs/heads/main/Data/sgx.png" alt="SGX Nifty Chart New" className="w-full rounded-lg border-2 border-brand-black" />
      </Section>
    </Page>,
    ...
    // NEW Page 11 (was page 11): Legal
    <LegalPage key="page-11" pageNumber={11} />,
  ];
